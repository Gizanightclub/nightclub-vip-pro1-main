...
export async function generateMetadata(): Promise<Metadata> {
  // 👇 عناوين ديناميكية متنوعة لتحسين SEO وتجنب التكرار
  const dynamicTitles = [
    "🔥 أرخص نايت كلوب في مصر 2025 | خصم 50% - احجز الآن",
    "⭐ أفضل Nightclub في القاهرة | أسعار مميزة من 750 جنيه",
    "🎉 أفضل نايت كلوب VIP | عروض ديسكو حصرية مع النجوم",
    "💫 نايت كلوب مصر | حفلات مع رحمة محسن وعصام صاصا",
    "🎶 نايت كلوب العجوزة | أفضل سهرات 2025 مع بوسي وروح",
    "🌟 افضل نايت كلوب في الجيزة | خدمة VIP فاخرة"
  ];

  // اختيار عنوان عشوائي لتنويع الظهور في البحث
