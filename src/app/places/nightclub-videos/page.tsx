  ...
  return (
    <>
      <SEOUnified
        ...
        customDescription="شاهد فيديوهات تجارب النايت كلوب VIP في القاهرة والساحل وشرم. احجز الآن عبر 01286110562."
        customKeywords={["فيديو نايت كلوب", "Night Club Videos", "VIP videos", "حجز نايت كلوب"]}
      />
