...
export const metadata: Metadata = {
  title: {
    default: "🔥 أفضل نايت كلوب في مصر 2026 - أسعار تبدأ من 750 جنيه | احجز الآن",
    template: "%s | Night Club Egypt - أفضل نايت كلوب في مصر"
  },
  description: "🔥 نايت كلوب من الآخر في مصر 2026! أحلى أجواء وسهرات مع أشهر النجوم: رحمة محسن، عصام صاصا، بوسي، روح 🎶 خدمة VIP فخمة، رقص شرقي وديسكو، DJs عالميين. الأسعار تبدأ من 750 جنيه بس 💸 في القاهرة، الجيزة، العجوزة، الشيخ زايد، الزمالك. احجز دلوقتي 📞 01286110562",
  ...
  keywords: [
   ...
   "أفضل نايت كلوب في مصر", "ملهى ليلي VIP", "نادي ليلي فاخر", "Night Club Egypt", "احجز نايت كلوب", "حفلات ليلية فاخرة", "سهرات مميزة مصر",
    ...
    "كويتي في مصر", "إماراتي يسهر", "سعودي في القاهرة",
    
    // كلمات موسيقى وترفيه
    "حفلات موسيقية مصر", "عروض راقصات", "رقص شرقي مصر", "عروض فنية", "ليالي موسيقية",
    "DJ محترف", "موسيقى حية", "حفلات غنائية", "ليالي غنائية",
    
    // كلمات الحجز والدفع
    "احجز نايت كلوب مصر", "أسعار 750 جنيه", "باقة VIP 1500", "حجز فوري", "دفع InstaPay",
    "حجز واتساب", "رقم الحجز", "01286110562", "WhatsApp nightclub", "booking form"
  ].join(", "),
  ...
  openGraph: {
    title: "🔥 Night Club Egypt | أفضل نايت كلوب في مصر 2026 - أسعار من 750 جنيه",
  ...
  return (
    <html lang="ar" dir="rtl" className={`${cairo.variable} ${inter.variable}`}>
      ...
      <body className="min-h-screen text-white font-cairo antialiased">
        ...
        <VideoProvider>
          <BackgroundAudio src="/videos/dj.m4a" volume={0.05} />
          {children}
        </VideoProvider>
