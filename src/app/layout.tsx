...
export const metadata: Metadata = {
  ...
  description:
    "Night Club Egypt - أفضل نايت كلوب في القاهرة. حفلات مميزة، عروض حية، أجواء VIP فاخرة، وخدمة استثنائية. احجز الآن واستمتع بأجمل الليالي في مصر.",
  keywords:
    "نايت كلوب مصر, القاهرة, حفلات, سهرة, VIP, ترفيه, موسيقى, Night Club Egypt, nightclubegypt, party, entertainment",
  ...
  openGraph: {
    ...
    description:
      "استمتع بأفضل سهرة ليلية في القاهرة مع حفلات مميزة وخدمة VIP فاخرة في Night Club Egypt",
    type: "website",
  ...
  return (
    <html lang="ar" dir="rtl" className="scroll-smooth">
      <head>
        ...
        {/* ✅ JSON-LD باستخدام dangerouslySetInnerHTML */}
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              description:
                "أفضل نايت كلوب في القاهرة مع حفلات مميزة وخدمة VIP فاخرة",
              url: "https://nightclubegypt.com",
              ...
              sameAs: ["https://wa.me/201286110562"],
            }),
          }}
        />
      </head>
