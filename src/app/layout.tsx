...
export const metadata: Metadata = {
  ...
  description: "🔥 نايت كلوب من الآخر في مصر 2025! أحلى أجواء وسهرات مع أشهر النجوم: رحمة محسن، عصام صاصا، بوسي، روح 🎶 خدمة VIP فخمة، رقص شرقي وديسكو، DJs عالميين. الأسعار تبدأ من 750 جنيه بس 💸 في القاهرة، الجيزة، العجوزة، الشيخ زايد، الزمالك. احجز دلوقتي 📞 01275821053",
  ...
  openGraph: {
    ...
    images: [
      ...
      {
        url: "https://www.nightclubegypt.com/images/1000799787.jpg",
        width: 1200,
        height: 630,
